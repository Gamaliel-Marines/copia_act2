...
// =================================================================
template <class T>
pair<int, int> sequentialSearch(const vector<T> &v, T key) {
	int count{};
	for (int i = 0; i < v.size(); i++){
		++count;
		if (v[i] == key){
			return pair<int, int>(i, count);
		}
	}
...
// =================================================================
template <class T>
pair<int, int> binarySearch(const vector<T> &v, T key) {
